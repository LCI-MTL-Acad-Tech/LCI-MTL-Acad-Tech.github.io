...
const T = {
  fr: {
    ...
    'w-sub':"Réponds à quelques questions et découvre les programmes qui correspondent le mieux à ton profil.",
    ...
    shareCopied:'✓ Copié !', shareSubject:'Mes programmes', noMoreQ:'Tu as déjà répondu à toutes les questions.',
    ...
    warnInt:"Programme de moins de 2 ans — les étudiant·e·s internationaux·ales doivent vérifier les conditions de leur permis d'études (CAQ).",
    ...
    warnGlobal:"Rappel : étudier en anglais au Québec exige de réussir un examen de français pour obtenir ton diplôme. On offre des cours de soutien linguistique inclus dans ton programme.",
  },
  en: {
    'w-eyebrow':'Tech & design','w-title':'Find your program',
    'w-sub':'Answer a few questions and discover the programs that best match your profile.',
    ...
    shareCopied:'✓ Copied!', shareSubject:'My top programs', noMoreQ:'You have already answered all of the questions.',
    ...
    warnInt:'Program under 2 years — international students should verify their study permit (CAQ) conditions.',
    ...
    warnFrBeg:'Important: Insufficient French may prevent graduation. Law 14 requires passing the EUF for a DEC and proof of French Level 7 for an AEC. Free French courses are available.',
  ...
  es: {
    ...
    'w-sub':'Responde algunas preguntas y descubre los programas que mejor se adaptan a tu perfil.',
...
const PROGS = [
  ...
  { id:'reseaux-dec', code:'420.B0', type:'DEC', dur:3, fac:'tech', col:'#685ef7', visible:true,
    ...
    detail:{
      ...
      future:{fr:["Le Québec a subi des cyberattaques majeures ces dernières années (hôpitaux, municipalités) — la demande en spécialistes est en hausse directe","La cybersécurité est maintenant une priorité dans pratiquement toutes les organisations","Les rançongiciels et attaques sur les infrastructures critiques sont en augmentation mondiale","L'IA est utilisée des deux côtés : par les attaquant·e·s pour automatiser les attaques, et par les défenseur·e·s pour les détecter","Pénurie chronique dans ce domaine — les perspectives d'emploi à la sortie sont parmi les meilleures"],en:["Quebec has suffered major cyberattacks in recent years (hospitals, municipalities) — specialist demand is rising directly","Cybersecurity is now a priority in virtually every organization","Ransomware and attacks on critical infrastructure are increasing globally","AI is used on both sides: by attackers to automate attacks, and defenders to detect them","Chronic shortage in this field — job prospects upon graduation are among the best"],es:["Quebec ha sufrido importantes ciberataques recientes (hospitales, municipios) — la demanda de especialistas crece directamente","La ciberseguridad es ahora una prioridad en prácticamente todas las organizaciones","Los ransomware y ataques a infraestructuras críticas aumentan globalmente","La IA se usa en ambos lados: atacantes y defensores","Escasez crónica en este campo — las perspectivas de empleo son de las mejores del Colegio"]}
    }
  },
